...
import com.intuit.craft.demo.feed.controller.TweetResource;
...
public class TweetResourceIntTest {
    ...
    public void updateTweet() throws Exception {
        ...
        // Update the tweet
        Optional<Tweet> updatedTweet = tweetRepository.findById(tweet.getId());
        updatedTweet.get()
            .tweetText(UPDATED_TWEET_TEXT)
            .createdAt(UPDATED_CREATED_AT)
            .lang(UPDATED_LANG);
        TweetDTO tweetDTO = tweetMapper.toDto(updatedTweet.get());
