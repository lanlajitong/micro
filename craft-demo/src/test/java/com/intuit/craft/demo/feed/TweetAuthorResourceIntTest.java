package com.intuit.craft.demo.feed;

import static com.intuit.craft.demo.feed.TestUtil.sameInstant;
...
import com.intuit.craft.demo.CraftDemoApplication;
import com.intuit.craft.demo.feed.controller.TweetAuthorResource;
import com.intuit.craft.demo.feed.controller.errors.ExceptionTranslator;
...
@SpringBootTest(classes = CraftDemoApplication.class)
public class TweetAuthorResourceIntTest {
    ...
    public void updateTweetAuthor() throws Exception {
        ...
        Optional<TweetAuthor> updatedTweetAuthor = tweetAuthorRepository.findById(tweetAuthor.getId());
        updatedTweetAuthor.get()
            .screenname(UPDATED_SCREENNAME)
            .name(UPDATED_NAME)
            .createdAt(UPDATED_CREATED_AT)
            .profileImageUrl(UPDATED_PROFILE_IMAGE_URL);
        TweetAuthorDTO tweetAuthorDTO = tweetAuthorMapper.toDto(updatedTweetAuthor.get());
